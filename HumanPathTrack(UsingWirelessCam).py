...
address = "http://_________________/video"  # In place of '_______' write https of your webcam
cap.open(address)
...
while cap.isOpened():
    ...
    if success:
        ...
        # Check if yolo_results is not None and yolo_results[0].boxes is not None
        if yolo_results is not None and yolo_results[0].boxes is not None:
